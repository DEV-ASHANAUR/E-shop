<?php
    ...
    <div style='background: linear-gradient(rgba(0, 0, 0, 0.637), rgba(0, 0, 0, 0.637)), url("img/offer/78070729_1637885703003441_4131103418800406528_n.png");
	height: 50vh;
	width: 100%;
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="category text-center">
                        <h2>Mega Sale</h2>
                        <span>E-Shop</span><i class="fas fa-arrow-right"></i><span>Offer</span>
                    </div>
                </div>
            </div>
        </div>
