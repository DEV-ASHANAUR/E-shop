...
<html class="no-js" lang="">
    <head>
        ...
        <link href="https://fonts.googleapis.com/css?family=Josefin+Slab|Source+Serif+Pro&display=swap" rel="stylesheet">
    </head>
    <body>
    <!--top bar-->
                    ...
                    <div
                        ...
                        <div class="top-right-header">
                            <ul>
                                ...
                                <li><a href="pop_out.php">help</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
            ...
            <div class="container-fluid">
                <div class="row m-0">
                                                ...
                                                <?php 
                                                    if($cat_data->num_rows>0){
                                                        while($row = $cat_data->fetch_object()){
                                                            ?>
                                                            <li><a href="catagory.php?id=<?php echo $row->id;?>"><?php echo $row->cat_name;?></a></li>
                                                            <?php
                                                        }
                                                    }
                                                ?>
                    ...
                    <div class="col-xl-3 col-lg-3 col-md-6 col-sm-4 d-md-block icon" style="padding: 0; margin: 0;">
                        <div class="last-menu">
                            <ul>
                                <li><a data-toggle="tooltip" data-placement="right" title="My WishList" href="wishlist.php"><i class="fa fa-heartbeat"></i>
                                <?php
